            ...
            <div class="site-menu">
                <ul class="menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="devops-and-autometion.html">Platform Engeniering Services
                            <span class="border border-top"></span>
                            <span class="border border-right"></span>
                            <span class="border border-bottom"></span>
                            <span class="border border-left"></span>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 offset-xl-1 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="devops-and-autometion.html">Platform Engeniering Services</a></li>
